...
INSERT INTO skus (code, name, description, unit) VALUES
    ('SKU-A100', 'Rockwool Slab 100mm',   'Standard slab, 100 mm, 1200×600',   'packages'),
    ('SKU-A200', 'Rockwool Slab 50mm',    'Standard slab, 50 mm, 1200×600',    'packages'),
    ('SKU-B150', 'Wired Matt 50mm',       'Wired matt, 50 mm, 2000×1200',      'packages'),
    ('SKU-B300', 'Wired Matt 100mm',      'Wired matt, 100 mm, 2000×1200',     'packages'),
    ('SKU-C400', 'Pipe Section 30/20',    'Pipe insulation, DN20, 30mm shell', 'packages'),
    ('SKU-C500', 'Pipe Section 50/25',    'Pipe insulation, DN25, 50mm shell', 'packages'),
    ('SKU-D100', 'Flexi Roll 25mm',       'Flexible roll, 25 mm, 7200×1200',   'packages'),
    ('SKU-D250', 'Flexi Roll 50mm',       'Flexible roll, 50 mm, 3600×1200',   'packages'),
    ('SKU-E350', 'Facade Slab 100mm',     'Facade slab, 100 mm, 1200×400',     'packages'),
    ('SKU-E500', 'Facade Slab 150mm',     'Facade slab, 150 mm, 1200×400',     'packages')
ON CONFLICT (code) DO NOTHING;

-- ── Production lines ──────────────────────────────────────────────────────────

INSERT INTO production_lines (id, name, description, status) VALUES
    (1, 'Line 1',       'Production line 1',                    'active'),
    (2, 'Line 2',       'Production line 2',                    'active'),
    (3, 'Briquette',    'Briquette production line',            'active'),
    (4, 'Wired Matts',  'Wired matt production line',           'active'),
    (5, 'Rockfon',      'Rockfon ceiling tiles line',           'active'),
    (6, 'Grodan',       'Grodan horticultural media line',      'active')
...
INSERT INTO materials (code, name, unit, stock_quantity) VALUES
    ('MAT-001', 'Basalt Fibre',         'kg',    5000),
    ('MAT-002', 'Phenol Binder',        'kg',    3200),
    ('MAT-003', 'PE Shrink Film',       'm2',   12000),
    ('MAT-004', 'Stretch Wrap',         'm2',    8500),
    ('MAT-005', 'Pallet 1200×1000',    'pcs',     450),
    ('MAT-006', 'Basalt Rock',          'kg',   85000),
    ('MAT-007', 'Volcanic Tuff',        'kg',   24000),
    ('MAT-008', 'Petroleum Coke',       'kg',   18000),
    ('MAT-009', 'PP Film Roll',         'm',    45000)
ON CONFLICT (code) DO NOTHING;
...
INSERT INTO products (number, description, sku, code, package_code, initial_code, instruction,
                      length, width, thickness, density)
VALUES
    ('PRD-A100', 'Rockwool Slab 100mm',  'SKU-A100', 'WM-SL-100',  'PAK-SL-100',  'IA100',
     'Store horizontally. Max stack 4 pallets.',              1200, 600, 100, 100),
    ('PRD-A200', 'Rockwool Slab 50mm',   'SKU-A200', 'WM-SL-050',  'PAK-SL-050',  'IA200',
     'Store horizontally. Max stack 6 pallets.',              1200, 600,  50,  80),
    ('PRD-B150', 'Wired Matt 50mm',      'SKU-B150', 'WM-WR-050',  'PAK-WR-050',  'IB150',
     'Handle with care. Maintain vertical orientation.',      2000,1200,  50,  80),
    ('PRD-B300', 'Wired Matt 100mm',     'SKU-B300', 'WM-WR-100',  'PAK-WR-100',  'IB300',
     'Handle with care. Maintain vertical orientation.',      2000,1200, 100, 100),
    ('PRD-D100', 'Flexi Roll 25mm',      'SKU-D100', 'WM-FL-025',  'PAK-FL-025',  'ID100',
     'Roll must remain tightly wound during transport.',      7200,1200,  25,  40)
